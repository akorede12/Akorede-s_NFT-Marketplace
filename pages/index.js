...
// import bg from "./public/gb.JPG"; 
// add  a banner for the website header with Css. 
...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    const contract = new ethers.Contract(marketAddress, NFTMarket.abi, provider)
...
async function buyNft(nft) {
  /* needs the user to sign the transaction, we use Web3Provider and sign it */
